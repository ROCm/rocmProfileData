...
CREATE TABLE IF NOT EXISTS "rocpd_copyop" ("op_ptr_id" integer NOT NULL PRIMARY KEY REFERENCES "rocpd_op" ("id") DEFERRABLE INITIALLY DEFERRED, "size" integer NOT NULL, "src" integer NOT NULL, "dst" integer NOT NULL, "sync" bool NOT NULL, "pinned" bool NOT NULL);
