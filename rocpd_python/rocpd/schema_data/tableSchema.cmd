...
CREATE TABLE IF NOT EXISTS "rocpd_copyop" ("op_ptr_id" integer NOT NULL PRIMARY KEY REFERENCES "rocpd_op" ("id") DEFERRABLE INITIALLY DEFERRED, "size" integer NOT NULL, "dst" varchar(18) NOT NULL, "sync" bool NOT NULL, "pinned" bool NOT NULL, "dstDevice" integer NOT NULL, "height" integer NOT NULL, "kind" integer NOT NULL, "srcDevice" integer NOT NULL, "width" integer NOT NULL, "src" varchar(18) NOT NULL);
...
CREATE TABLE IF NOT EXISTS "rocpd_kernelop" ("op_ptr_id" integer NOT NULL PRIMARY KEY REFERENCES "rocpd_op" ("id") DEFERRABLE INITIALLY DEFERRED, "gridX" integer NOT NULL, "gridY" integer NOT NULL, "gridz" integer NOT NULL, "workgroupX" integer NOT NULL, "workgroupY" integer NOT NULL, "workgroupZ" integer NOT NULL, "groupSegmentSize" integer NOT NULL, "privateSegmentSize" integer NOT NULL, "kernelArgAddress" varchar(18) NOT NULL, "aquireFence" varchar(8) NOT NULL, "releaseFence" varchar(8) NOT NULL, "codeObject_id" integer NOT NULL REFERENCES "rocpd_kernelcodeobject" ("id") DEFERRABLE INITIALLY DEFERRED, "kernelName_id" integer NOT NULL REFERENCES "rocpd_string" ("id") DEFERRABLE INITIALLY DEFERRED);
